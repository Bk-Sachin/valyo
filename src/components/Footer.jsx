    ...
    <footer className="w-full bg-black text-white mt-20 pb-8 pt-12 px-0 sm:px-20">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-10 text-base mb-8">
        <div className="flex items-center gap-2">
          <span className="inline-block text-3xl text-blue-200">
            <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
              <rect x="4" y="10" width="16" height="10" rx="2" fill="#23232a" />
              <rect x="8" y="6" width="8" height="4" rx="2" fill="#23232a" />
              <rect x="10" y="12" width="4" height="4" rx="1" fill="#6366F1" />
            </svg>
          </span>
          Encrypted
        </div>
        <div className="flex items-center gap-2">
          <span className="inline-block text-3xl text-yellow-200">
            <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
              <rect x="3" y="5" width="18" height="14" rx="2" fill="#23232a" />
              <rect x="7" y="9" width="10" height="2" rx="1" fill="#fde68a" />
              <rect x="7" y="13" width="10" height="2" rx="1" fill="#fde68a" />
            </svg>
          </span>
        ...
        <div className="flex items-center gap-2">
          <span className="inline-block text-3xl text-purple-200">
            <svg width="32" height="32" fill="none" viewBox="0 0 24 24">
              <ellipse cx="8" cy="12" rx="3" ry="6" fill="#a78bfa" />
              <ellipse cx="16" cy="12" rx="3" ry="6" fill="#a78bfa" />
              <ellipse cx="12" cy="12" rx="2" ry="4" fill="#23232a" />
            </svg>
          </span>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-6 text-gray-300 text-sm">
        ...
        <div className="flex items-center gap-6 mb-2 sm:mb-0">
          ...
          >
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
              <rect x="3" y="3" width="18" height="18" rx="4" fill="#23232a" />
              <rect x="7" y="7" width="10" height="10" rx="2" fill="#fff" />
            </svg>
          </a>
        </div>
        <div className="text-gray-400 text-xs">© Valyo, 2025</div>
      </div>
    </footer>
  );
};
